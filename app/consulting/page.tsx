...
<div className="mb-6">
<div className="text-6xl font-bold text-sky-400 mb-2">$250</div>
...
<div>
<div className="font-semibold text-slate-300">Full Session</div>
<div className="text-sm text-slate-400">90-minute dedicated consulting call</div>
</div>
</div>
<div className="flex items-center gap-3">
<CheckCircle2 className="h-5 w-5 text-emerald-400 flex-shrink-0" />
<div>
<div className="font-semibold text-slate-300">Deliverables Included</div>
<div className="text-sm text-slate-400">Session notes, action items, and recommendations</div>
</div>
</div>
<div className="flex items-center gap-3">
<Users className="h-5 w-5 text-emerald-400 flex-shrink-0" />
<div>
<div className="font-semibold text-slate-300">Follow-Up Support</div>
<div className="text-sm text-slate-400">7 days of email support after the session</div>
</div>
</div>
<div className="flex items-center gap-3">
<Zap className="h-5 w-5 text-emerald-400 flex-shrink-0" />
<div>
<div className="font-semibold text-slate-300">Priority Booking</div>
<div className="text-sm text-slate-400">Schedule within 48 hours of request</div>
</div>
</div>
</div>
</div>
