...
export default function AboutPage() {
  ...
  const coreValues = [
    ...
    },
    {
      ...
      icon: <Check className="h-6 w-6 text-sky-400" />,
    },
  ]
  ...
  return (
    <main className="min-h-screen bg-[#030712]">
      ...
      <SkyBackground className="w-full py-16 md:py-24 bg-gradient-to-b from-slate-900 to-[#030712]">
        <div className="container px-4 md:px-6 mx-auto">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="max-w-[800px] mx-auto text-slate-200 md:text-xl mb-8">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="relative pb-4">
              ...
              <div className="mt-6 text-center">
                <h3 className="text-xl font-semibold text-sky-400">See Our Vision in Action</h3>
        ...
        <div className="container px-4 md:px-6 mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto">
            {whatWeDo.map((item, index) => (
              <Card key={index} className="border-0 bg-white/5 border-white/10 shadow-lg shadow-black/20">
                <CardContent className="p-6 text-center">
                  <div className="w-12 h-12 rounded-full bg-sky-500/20 flex items-center justify-center mx-auto mb-4">
                    {item.icon}
                  </div>
                  <h3 className="text-xl font-bold text-sky-400 mb-2">{item.title}</h3>
      ...
      <section className="py-16 bg-[#030712]">
        <div className="container px-4 md:px-6 mx-auto">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-white mb-6 text-center">Why Organizations Choose Us</h2>
            <div className="prose prose-lg mx-auto">
              <p className="text-slate-300">
              ...
              <p className="text-slate-300">When you work with Donjon Intelligence Systems, you get:</p>
      ...
      <section className="py-16 bg-[#030712]">
        <div className="container px-4 md:px-6 mx-auto">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-white mb-6 text-center">The Technology Behind Our Solutions</h2>
            <div className="prose prose-lg mx-auto">
              <p className="text-slate-300">
      ...
      <section className="py-16 bg-slate-900/30">
        <div className="container px-4 md:px-6 mx-auto">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-white mb-6 text-center">Open Development & Knowledge Sharing</h2>
            <div className="prose prose-lg mx-auto">
              <p className="text-slate-300">
      ...
      <section className="py-16 bg-[#030712]">
        <div className="container px-4 md:px-6 mx-auto">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-white mb-6 text-center">What Sets Us Apart</h2>
            <div className="prose prose-lg mx-auto">
              <p className="text-slate-300">
      ...
      <section className="py-16 bg-slate-900/30">
        <div className="container px-4 md:px-6 mx-auto">
          <h2 className="text-3xl font-bold text-sky-400 mb-12 text-center">Meet Our Team</h2>
            ...
            {teamMembers.map((member, index) => (
              <div key={index} className="text-center max-w-xs">
                <div className="mb-4 relative mx-auto w-48 h-48 overflow-hidden">
                  <div className="rounded-full overflow-hidden w-48 h-48 border-4 border-sky-500 shadow-lg">
                    <img
                ...
                <h3 className="text-xl font-bold text-sky-400">{member.name}</h3>
                <p className="text-sky-400 font-medium mb-2">{member.role}</p>
      ...
      <section className="py-16 bg-[#030712]">
        <div className="container px-4 md:px-6 mx-auto">
          <h2 className="text-3xl font-bold text-sky-400 mb-12 text-center">Our Core Values</h2>
            ...
            {coreValues.map((value, index) => (
              <Card key={index} className="border-0 bg-white/5 border-white/10 shadow-lg shadow-black/20">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="text-xl font-bold text-sky-400 mb-2">{value.title}</h3>
      ...
      <section className="py-16 bg-slate-900/30">
        <div className="container px-4 md:px-6 mx-auto">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-white mb-6 text-center">Ready to Build Resilient Intelligence?</h2>
            <div className="prose prose-lg mx-auto">
              <p className="text-slate-300">
      ...
      <section className="py-16 bg-[#030712]">
        <div className="container px-4 md:px-6 mx-auto">
          <h2 className="text-3xl font-bold text-white mb-12 text-center">Our Roadmap</h2>

          <div className="max-w-4xl mx-auto">
            <div className="space-y-8">
              {keyMilestones.map((milestone, index) => (
                <div key={index} className="relative pl-8 sm:pl-32 py-4">
                  <div className="flex flex-col sm:flex-row items-start mb-1 group-last:before:hidden before:absolute before:left-2 sm:before:left-12 before:h-full before:px-px before:bg-white/10 before:ml-0.5 before:top-6 before:bottom-0">
                    <div className="absolute left-0 sm:left-10 top-6 flex items-center justify-center w-5 h-5 rounded-full bg-sky-500 border-4 border-[#030712] text-white">
                      <Calendar className="w-3 h-3" />
                    </div>
                    <div className="font-bold text-lg text-sky-400 w-32 hidden sm:block">{milestone.date}</div>
                    <div>
                      <div className="sm:hidden font-bold text-lg text-sky-400 mb-1">{milestone.date}</div>
                      <div className="text-xl font-bold text-white">{milestone.title}</div>
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <Button
                size="lg"
                variant="outline"
                className="bg-white/10 text-white hover:bg-white/30 border-white/20"
                asChild
              >
